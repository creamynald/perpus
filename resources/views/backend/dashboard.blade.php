                            ...
                            <a class="block block-rounded block-link-rotate text-end" href="javascript:void(0)">
                                <div
                                    ...
                                    <div class="text-end">
                                        ...
                                        <div class="fs-sm fw-semibold text-uppercase text-muted">Transaksi Peminjaman</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                    @endrole
                    @role(['siswa', 'super admin'])
                        <div class="col-6 col-xl-3">
                            <a class="block block-rounded block-link-rotate text-end" href="javascript:void(0)">
                                <div
                                    class="block-content block-content-full d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        <div class="fs-3 fw-semibold">{{ $totalPeminjamanUser }}</div>
                                        <div class="fs-sm fw-semibold text-uppercase text-muted">Pustaka telah dipinjam</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-6 col-xl-3">
                            <a class="block block-rounded block-link-rotate text-end" href="javascript:void(0)">
                                <div
                                    ...
                                    <div class="text-end">
                                        <div class="fs-3 fw-semibold">{{ $pointSaya }}</div>
                                        <div class="fs-sm fw-semibold text-uppercase text-muted">Total Point saya
                                            ({{ Auth::user()->name }})</div>
                                    </div>
                                </div>
                            </a>
